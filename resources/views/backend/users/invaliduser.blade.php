...
<div class="page-content">
	<nav class="page-breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('users.invalid') }}">Users</a></li>
            ...
            <div class="card">
				<div class="card-body">
					...
					<div class="dropdown mb-2 float-right">
                        <a href="{{ route('users.validexport', 0) }}"><button class="btn p-0" type="button">Download Data With CSV File</button></a>
                    </div>
