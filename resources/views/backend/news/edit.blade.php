	...
	<div>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
				...
				<div class="card-body">
<form method="post" action="{{route('admin.news.update',['id'=>$f->id])}}" class="form" enctype="multipart/form-data">
    @method('PUT')
    @csrf
                @include('alert-comp')
        <div class="row">
        ...
        <div class="row" >
            ...
            @php
            $src='';
            if($f->featured_image && file_exists(storage_path('app/public/news/'.$f->featured_image))) 
                $src=asset('storage/news/'.$f->featured_image);
