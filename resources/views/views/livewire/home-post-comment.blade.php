<div class="bg_box_fixed">
   ...
   <div class="xf_inside">
      <h4 class="padd-sec">Create a Post</h4>
      <div class="box_text padd-sec">
         <div class="form_sec_post">
            <div class="input_post">
               <img src="{{user_pic(auth()->id())}}" alt="Profile pic">
               <input class="f" wire:model.defer="post_content" name="content" wire:keydown.enter="postContent" type="text" placeholder="Your thoughts here...">
