<div wire:ignore.self id="img"  class="modal fade" role="dialog" style="z-index:1">
    ...
    left: 92%;">&#127773;</button>
                        ...
                        <input type="file" wire:model="image" name="image" id="inp" style="visibility:hidden" />
                        <div wire:ignore style="height:200px;overflow-y:auto;border:1px dashed grey;position:relative;cursor:pointer" onclick="document.querySelector('#inp').click()">
                          
                           <p style="position:absolute;top:50%;left:50%;font-weight:bold;transform: translate(-50%, -50%);" id="te">Upload Image</p>
                           ...
                           <img id="blah" src="#" alt="your image" style="visibility:hidden;width:100%;height:auto;border-radius:0!important;"/>
                        
                        
                        </div>
                     </div>
                     <div class="modal-footer" style="border:0!important">
                        <button type="button" style="font-size:13px;" class="follow_btn btn btn-success" id="sub1"  wire:click="postContent" wire:loading.attr="disabled">
