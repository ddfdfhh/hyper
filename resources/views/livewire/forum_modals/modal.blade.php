...
<div class="modal " id="myModal" wire:ignore.self>
  <div class="modal-dialog modal-xl" style="max-height:100vh!important;overflow-y:auto">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">@if($selected_forum) Edit @else Create @endif Forum</h4>
 ...
 <textarea  name="details"  rows='60' class="form-control" id="summernote"></textarea>
        ...
        <div class="row" >
            ...
            @php
            $src='';
            if(file_exists(storage_path('app/public/forum/'.$feature_image))) 
                $src=asset('storage/forum/'.$feature_image);
            else
      ...
      <button type="button"  @if(!$selected_forum) wire:click.prevent="store" @else wire:click.prevent="update"  @endif class="btn btn-primary">
