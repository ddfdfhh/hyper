            ...
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                     <div class="mail_info">
                        <a href="mailto:info@hypermeteor.co.uk"><img src="{{ asset('assets/frontend/images/svg/Icon-metro-mail-read.svg') }}"> info@hypermeteor.co.uk</a>
                     </div>
                  </div>
                     ...
                     <div class="left_side_bar">
                        ...
                        <div id="mySidenav" class="sidenav">
                           ...
                           <div class="left_sider_section text-center">
                              <a href="#"> <img src="{{ asset('assets/frontend/images/blackslogo.png') }}"></a>
<!--
                     ...
                     <div class="mobile_menu">
                        <div class="header_logo_mobile">
                           <a href="{{ route('index') }}">
                            @php $logo = Helper::instance()->general_settings('logo'); @endphp
                               ...
                               @else
                                <img  src="{{ asset('assets/frontend/images/blackslogo-header.png') }}">
                               @endif
                           </a>
                        </div>
                        ...
                        <nav class="main-nav" role="navigation">
                           ...
                           <ul id="main-menu" class="sm sm-clean">
                              <li><a href="{{ route('aboutus') }}">Who Are Hyper Meteor</a></li>
                              <!-- <li><a href="{{ route('team') }}">Meet The Team</a></li> -->
                              <li><a href="https://hypermeteor.shop/" target="_blank">Store</a></li>
                              <li><a href="https://crypto.com/nft/profile/hypermeteorltd" target="_blank">NFT Store</a></li>
                              <li><a href="{{ asset('assets/frontend/pdf/Hyper-Unity-White-Paper.pdf') }}" target="_blank">White Paper</a></li>
                     ...
                     <nav class="navbar-expand-lg desktop_menu">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                           <ul class="navbar-nav start-nav">
						       <li class="nav-item active"><a class="nav-link" href="partnerships-and-collaborations">Partnerships</a></li>
                           
                              <li class="nav-item">
                                 <a class="nav-link active" aria-current="page" href="{{ route('aboutus') }}">Who Are Hyper Meteor</a>
                              </li>
                              <!--<li class="nav-item"><a class="nav-link" href="{{ route('team') }}">Meet The Team</a></li>-->
                              <li class="nav-item"><a class="nav-link" target="_blank" href="https://hypermeteor.shop/">Store</a></li>
                           </ul>
                           <div class="header_logo">
                              <a href="{{ route('index') }}">
                              @php $logo = Helper::instance()->general_settings('logo'); @endphp
                               @if($logo->logo)
                                <img  class="header_logo_sin" src="{{ url('storage/app/uploads/logo/'.$logo->logo) }}">
                               @else    
                              <img class="header_logo_sin" src="{{ asset('assets/frontend/images/blackslogo-header.png') }}">
                              @endif
                              <img class="header_logo_bg" src="{{ asset('assets/frontend/images/svg/logo_bg.svg') }}">
                              </a>
                           </div>
                           <ul class="navbar-nav last_nav">
                              <li class="nav-item"><a class="nav-link" href="https://crypto.com/nft/profile/hypermeteorltd" target="_blank">NFT Store</a></li>
                              <li class="nav-item"><a class="nav-link" href="{{ asset('assets/frontend/pdf/Hyper-Unity-White-Paper.pdf') }}" target="_blank"> White Paper</a></li>
                              <li class="nav-item"><a class="nav-link" href="{{ route('contactus') }}">Contact Us</a></li>
                           </ul>
                        </div>
                     </nav>
                  </div>
                  <div class="col-lg col-md col-sm col d-lg-block d-md-none d-none">
